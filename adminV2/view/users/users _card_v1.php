                    ...
                    <form  id="frmtask" name="frmtask" action="#" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12" id="divmodelofirma" style="display:none;background:#18344d;width:450px">
                                <div style="background:#18344d; padding:5%;color:#FFF"  id="divimagenfirma">
                                  <div class="row">
                                    <div class="col-md-8 col-sm-8 col-xs-12">  
                                          <img src="../menu/proelco-logo.webp" class="img-responsive" style="width:130px;"> </br></br>
                                          <label style="font-size:1.4em;margin-bottom:0" id="nameuser"><strong>Diego Alberto Hernandez Vargas</strong></label></br>
                                          <label style="font-size:1.2em;margin-top:-20px;" id="jobtitle"><strong>Ingeniero/a</strong></label></br>
                                          <i class="fa fa-envelope" style="margin-bottom:0;font-size:1em"></i>&nbsp;<label id="lblemail" style="margin-bottom:0;font-size:1.1em" >dahernandez@desarrollaloya.com </label></br>
                                          <i class="fa fa-mobile"style="margin-bottom:0;font-size:1em"></i>&nbsp;<label id="lblcellphone" style="margin-bottom:0;font-size:1.1em">(+57) 3012550175 </label></br>
                                          <i class="fa fa-phone" style="margin-bottom:0;font-size:1em"></i>&nbsp;<label id="lblphone" style="margin-bottom:0;font-size:1.1em"> (+57) 3012550175 </label></br>
                                          <i class="fa fa-map-marker"style="margin-bottom:0;font-size:1em">&nbsp;</i><label id="lbladdress" style="margin-bottom:0;font-size:1.1em">(+57) 3012550175 </label></br>
                                          <i class="fa fa-globe"style="margin-bottom:0;font-size:1"></i>&nbsp;<label id="lblurl" style="margin-bottom:0;font-size:1.1em"> (+57) 3012550175 </label></br>
                                          <label id="lblcity" style="margin-bottom:0;font-size:1.1em">&nbsp;&nbsp; Bogota </label></br>
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="col-md-12 col-sm-12 col-xs-12" style="padding-top:10%">
                                            <div class="text-center" style="background-color:#FFF;position:absolute">
                                              <br>                                           
                                              <label style="color:#18344d; font-size:1em">Accede a mi tarjeta virtual</label>
                                              <img src="<?php echo $filevcardimage; ?>" style="width:90%" id="QRCardImg"><br>
                                            </div>
                                        </div>  
                                    </div>                                          
                                  </div>  
