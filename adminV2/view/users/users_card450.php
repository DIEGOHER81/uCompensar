                                  ...
                                  <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">  
                                        <p style="color:#FFF">
                                          ...
                                          <label style="font-size:1.4em;margin-top:-10px;" id="jobtitle"><strong>Ingeniero/a</strong></label></br>
                                        </p>  
                                    </div>
                                    <div class="row" style="margin-top:-3%">
                                        <div class="col-md-8 col-sm-8 col-xs-12" style="padding-right: 0!important;color:#FFF">  
                                                  <div class="col-md-12 col-sm-12 col-xs-12" style="color:#FFF">
                                                    ...
                                                    <i class="fa fa-map-marker"style="margin-bottom:0;font-size:1em">&nbsp;</i>(+57) 3012550175 </label></br>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                          ...
                                          <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                                <img src="../menu/proelco-logo.webp" class="img-responsive" style="width:100px;">    
                                            </div>
                                          </div>  
                                        </div>                                          
