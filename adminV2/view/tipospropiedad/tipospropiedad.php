...
<body class="nav-md">
              ...
              <div class="x_panel">
                <div class="row">
                  <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2><i class="fa fa-bars"></i> <small>Configuración / Generos Película</small></h2>
                      ...
                      <div class="x_content">
                        <form id="frmtipopropiedad" name="frmtipopropiedad" method="post" action="#">
              ...
              <div class="x_panel">
                <div class="row">
                  <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2><i class="fa fa-bars"></i> <small>Relación de tipos de propiedad</small></h2>
                        <ul class="nav navbar-right panel_toolbox">
                          <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                          </li>
                        </ul>
                      ...
                      <div class="x_content">
                          <div id="divlsttipospropiedad">
                            <table id="tbltipospropiedad" class="table table-striped table-bordered" style="width:100%">
                              <thead>
                                <th>Id</th>
                                <th>Descripción</th>
                                <th>Acciones</th>
            ...
            <div class="modal-dialog modal-sm">
              <div class="modal-content">
                <div class="modal-header">
                  <h2 class="modal-title" id="myModalLabel2"><small>Confirmación</small></h2>
  ...
  <!-- Custom js-->
  <script type="text/javascript" src="tipospropiedad.js"></script>
